    ...
    <>
      <footer className="p-10 bg-black text-white">
        <div className="footer max-w-5xl mx-auto">
          <aside>
            <h2 className="text-2xl">Dream Career Hub</h2>
            <p className="my-8">Providing reliable tech since 1992</p>
            <nav>
          ...
          <nav className="md:justify-self-end">
            ...
            <a className="link link-hover">Tampere, Finland</a>
            <a className="link link-hover">+35849999999</a>
          </nav>
        </div>
      </footer>
